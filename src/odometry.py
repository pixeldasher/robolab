...
# Define placeholder path dictionary
path_dict = {}

# Define several check function
def touch_check(n):
    if (n == 1):
...
# Define function for observing the surface's luminance
def luminance():
...
# Function which performs the checks
def check_phase():
